import type { ProjectIdentityKind } from "./generated/ProjectIdentityKind.js";
...
export const PROJECT_IDENTITY_KINDS = [
  ...
  "path",
  "loose",
] as const satisfies readonly ProjectIdentityKind[];

export type { ProjectIdentityKind } from "./generated/ProjectIdentityKind.js";
