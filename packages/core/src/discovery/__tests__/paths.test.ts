...
describe("resolveProviderRoots", () => {
  it("uses default paths when no env vars are set", () => {
    ...
    expect(roots.codexRoot).toBe("/home/user/.codex");
    expect(roots.claudeRoot).toBe("/home/user/.claude");
    expect(roots.kimiRoot).toBe("/home/user/.kimi");
  });
  ...
  it("respects CODEX_HOME override", () => {
    ...
    mockedHomedir.mockReturnValue("/home/user");
    const roots = resolveProviderRoots();
    expect(roots.codexRoot).toBe("/custom/codex");
  });
  ...
  it("respects CLAUDE_CONFIG_DIR override", () => {
    ...
    mockedHomedir.mockReturnValue("/home/user");
    const roots = resolveProviderRoots();
    expect(roots.claudeRoot).toBe("/custom/claude");
  });
  ...
  it("respects KIMI_SHARE_DIR override", () => {
    ...
    mockedHomedir.mockReturnValue("/home/user");
    const roots = resolveProviderRoots();
    expect(roots.kimiRoot).toBe("/custom/kimi");
  });
